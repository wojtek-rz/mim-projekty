@_global_0 = internal constant [1 x i8] c"\00"
@_global_1 = internal constant [2 x i8] c"a\00"
@_global_2 = internal constant [2 x i8] c"b\00"
...
entry:
    %temp_0 = call i1 @f()
    br i1 %temp_0, label %true_1, label %false_2
true_1:
    br label %continue_3
false_2:
    br label %continue_3
continue_3:
    %s3_0_7 = phi i8* [@_global_1, %true_1], [@_global_2, %false_2]
    call void @printString(i8* %s3_0_7)
    ret i32 0
}
...
define i8* @readString() {
    %res = call i8* @malloc(i32 256)
    %t1 = getelementptr [3 x i8], [3 x i8]* @_s, i32 0, i32 0
    call i32 @scanf(i8* %t1, i8* %res)
    ret i8* %res
}
