...
@_global_0 = internal constant [6 x i8] c"hejka\00"
@_global_1 = internal constant [4 x i8] c"abc\00"

define i32 @main() {
entry:
    %temp_0 = getelementptr [6 x i8], [6 x i8]* @_global_0, i32 0, i32 0
    %temp_1 = getelementptr [4 x i8], [4 x i8]* @_global_1, i32 0, i32 0
    %temp_2 = call i8* @_concat_strings(i8* %temp_1, i8* %temp_0)
