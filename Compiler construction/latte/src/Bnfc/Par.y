...
Stmt
  ...
  | 'for' '(' Type Ident ':' Expr ')' Stmt { (uncurry Bnfc.Abs.BNFC'Position (tokenLineCol $1), Bnfc.Abs.For (uncurry Bnfc.Abs.BNFC'Position (tokenLineCol $1)) (snd $3) (snd $4) (snd $6) (snd $8)) }
