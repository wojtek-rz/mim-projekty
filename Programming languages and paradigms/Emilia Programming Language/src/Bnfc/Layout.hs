...
layoutWords = [( TokSymbol ":" 13
               , LayoutDelimiters (TokSymbol ";" 15) (Just (TokSymbol "{" 34)) (Just (TokSymbol "}" 37))
               )]

layoutStopWords :: [TokSymbol]
layoutStopWords = [TokSymbol "else" 28]
...
parenOpen  = [TokSymbol "(" 4]
parenClose = [TokSymbol ")" 5]
